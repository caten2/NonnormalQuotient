...
from nonnormal_quotient import GroupQuotient, generate_subgroup_table
...
print('Generate the detailed multiplication table for this quotient.')
k.detailed_multiplication_table()